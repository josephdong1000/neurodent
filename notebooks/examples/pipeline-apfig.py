...
base_folder = Path('/home/dongjp/source-code/PyEEG/notebooks/tests/test-wars-full/').resolve()
save_folder = Path('/home/dongjp/Downloads/4-23-25_no-Z-score').resolve()
...
for animal_id in animal_ids:
    ...
    war = visualization.WindowAnalysisResult.load_pickle_and_json(base_folder / f'{animal_id}')
    ...
    # SECTION plot
    ap.plot_coherecorr_spectral(figsize=(20, 5), score_type='none')
