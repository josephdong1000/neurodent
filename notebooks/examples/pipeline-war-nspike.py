...
for animal_id in animal_ids:
    ...
    for sar in sars:
        sar.save_fif_and_json(Path(f'/home/dongjp/source-code/PyEEG/notebooks/tests/test-sars-full/{sar.animal_day}').resolve(),
                                overwrite=True)
    raws = [sar.convert_to_mne() for sar in sars]
...
"""
sbatch --mem 50G -c 5 -t 24:00:00 ./notebooks/examples/pipeline-war-nspike.sh
"""