...
class TestImportPatterns:
    ...
    def test_direct_class_imports(self):
        ...
        from pythoneeg.core import LongRecordingOrganizer, LongRecordingAnalyzer, FragmentAnalyzer
        from pythoneeg.core import DDFBinaryMetadata
    ...
    def test_module_level_access(self):
        ...
        import pythoneeg.core
        
        assert hasattr(pythoneeg.core, 'LongRecordingOrganizer')
        assert hasattr(pythoneeg.core, 'LongRecordingAnalyzer')
        assert hasattr(pythoneeg.core, 'FragmentAnalyzer')
        assert hasattr(pythoneeg.core, 'DDFBinaryMetadata')
    ...
    def test_import_consistency(self):
        ...
        from pythoneeg.core import LongRecordingOrganizer as direct
        import pythoneeg.core as core_module
        from pythoneeg import core as package_core
...
class TestCircularImports:
    ...
    def test_no_circular_import_errors(self):
        ...
        if 'pythoneeg.core' in sys.modules:
            del sys.modules['pythoneeg.core']
        if 'pythoneeg.core.analysis' in sys.modules:
            del sys.modules['pythoneeg.core.analysis']
        if 'pythoneeg.core.core' in sys.modules:
            del sys.modules['pythoneeg.core.core']
            
        # This should not raise any circular import errors
        import pythoneeg.core
        assert pythoneeg.core.LongRecordingOrganizer is not None
        assert pythoneeg.core.LongRecordingAnalyzer is not None
        
    def test_import_order_independence(self):
        """Test that import order doesn't matter."""
        # Test different import orders
        from pythoneeg.core import LongRecordingAnalyzer
...
class TestIDEFunctionality:
    ...
    def test_class_attributes_accessible(self):
        ...
        from pythoneeg.core import LongRecordingOrganizer, LongRecordingAnalyzer
    ...
    def test_module_dir_contents(self):
        ...
        dir_contents = dir(pythoneeg.core)
        expected_classes = [
        ...
        for item in expected_classes + expected_functions:
            assert item in dir_contents, f"{item} not found in dir(pythoneeg.core)"
...
class TestImportPerformance:
    ...
    def test_immediate_availability(self):
        ...
        from pythoneeg.core import LongRecordingOrganizer, FragmentAnalyzer
    ...
    def test_repeated_imports_cached(self):
        ...
        from pythoneeg.core import LongRecordingOrganizer
        from pythoneeg.core import LongRecordingOrganizer as LRO2
        ...
        import pythoneeg.core
        assert LongRecordingOrganizer is pythoneeg.core.LongRecordingOrganizer
...
class TestImportErrors:
    ...
    def test_nonexistent_import_error(self):
        ...
        with pytest.raises(ImportError):
            from pythoneeg.core import NonExistentClass
    ...
    def test_module_attribute_error(self):
        ...
        with pytest.raises(AttributeError):
            _ = pythoneeg.core.NonExistentClass
...
class TestVisualizationImports:
    ...
    def test_plotting_submodule_imports(self):
        ...
        from pythoneeg.visualization.plotting import AnimalPlotter, ExperimentPlotter
