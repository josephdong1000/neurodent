"""
Integration tests for pythoneeg.core.analysis module.
...
class TestLongRecordingAnalyzer:
    ...
    def test_compute_rms(self, analyzer, mock_long_recording):
        ...
        with patch('pythoneeg.core.analysis.FragmentAnalyzer.compute_rms') as mock_compute_rms:
            ...
            called_args = mock_compute_rms.call_args[1]['rec'] if 'rec' in mock_compute_rms.call_args[1] else mock_compute_rms.call_args[0][0]
...
class TestLongRecordingAnalyzerParameterPassThrough:
    ...
    def test_compute_pcorr_parameter_passthrough(self, analyzer):
        ...
        with patch.object(analyzer, 'get_fragment_np', return_value=test_data), \
            ...
            custom_params = {
                'lower_triag': False,
                'custom_correlation_param': 'test_string',
                'numeric_param': 3.14
            }
    ...
    def test_all_compute_methods_pass_fragment_data_correctly(self, analyzer):
        ...
        compute_methods = [
            ...
            'compute_psdfrac', 'compute_logpsdfrac', 'compute_psdslope',
            'compute_cohere', 'compute_zcohere', 'compute_pcorr', 'compute_zpcorr',
