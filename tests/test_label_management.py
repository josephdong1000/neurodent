...
def test_lro_label_merging_success():
    ...
    lro1 = LongRecordingOrganizer(item=None, recording=None, labels={"animal": "A1", "genotype": "WT"})
    lro2 = LongRecordingOrganizer(item=None, recording=None, labels={"day": "Jan-01-2023"})
...
def test_lro_label_merging_conflict_warning():
    ...
    lro1 = LongRecordingOrganizer(item=None, recording=None, labels={"animal": "A1", "genotype": "WT"})
    lro2 = LongRecordingOrganizer(item=None, recording=None, labels={"animal": "A1", "genotype": "KO"})
...
def test_lro_labels_inheritance_on_split():
    ...
    lro = LongRecordingOrganizer(item=None, recording=None, labels=parent_labels)
