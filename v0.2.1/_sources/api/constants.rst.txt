...
.. autodata:: LINEAR_FEATURES
   :annotation: = List of linear feature names

.. autodata:: BAND_FEATURES
   :annotation: = List of band feature names
...
.. autodata:: BAND_NAMES
   :annotation: = List of frequency band names
